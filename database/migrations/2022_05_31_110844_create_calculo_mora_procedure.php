...
return new class extends Migration
{
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `SP_CalcularValorInteresMora`;
                    ...
                    IF DATEDIFF(V_FECHA_FINAL_DIAS_GRACIA, V_FECHA_EJECUCION) >= 0 THEN
                        ...
                        ELSE
                            ...
                            ELSE
                                ...
                                IF DATEDIFF(V_FECHA_FINAL_DIAS_GRACIA, V_FECHA_ULTIMO_CALCULO_MORA) >= 0 THEN
                                    SELECT DATEDIFF(V_FECHA_ULTIMO_CALCULO_MORA, V_FECHA_EJECUCION) - 1 INTO V_DIAS_INTERESES_PERDIDOS;
                                ...
                                ELSE
                                    SELECT DATEDIFF(V_FECHA_VENCIMIENTO_CUOTA, V_FECHA_EJECUCION) - 1 INTO V_DIAS_INTERESES_PERDIDOS;
                                END IF;
