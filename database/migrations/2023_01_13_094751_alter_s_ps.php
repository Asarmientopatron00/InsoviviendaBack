...
return new class extends Migration
{
    ...
    public function up()
    {
        $procedure1 = "DROP PROCEDURE IF EXISTS `SP_PagosAplicarAbonoExtra`;
        ...
        $procedure2 = "DROP PROCEDURE IF EXISTS `SP_PagosAplicarEspecial`;
        ...
        $procedure3 = "DROP PROCEDURE IF EXISTS `SP_PagosAplicar`;
